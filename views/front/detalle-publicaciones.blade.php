...
@section('content')
@push('css')
<style>.pagination-row {padding-bottom: 30px;}.blog-list{border-bottom: transparent;}hr.pacman {border: 0;height: 25px;background-image: url('https://www.formget.com/wp-content/uploads/2014/12/type_3.png');background-repeat: no-repeat;background-position: center;}</style>
@endpush
